...
\begin{itemize}
  ...
  \item {\bf Windows:} The window will be double glazed and have a uPVC frame {\bf including trickle vents} and be fitted by a FENSA-approved contractor.
  \item {\bf Roof:} The warm flat roof will contain a 150\mm -thick layer of thermaset insulation.\cite{erins} The overall U-value of the roof is 0.15\uunit .
\end{itemize}
