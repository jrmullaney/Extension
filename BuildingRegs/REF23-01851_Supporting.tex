...
Resubmitted Supporting Documentation for 23/01851/FP}
\author{J. Mullaney}
\date{\today}

\maketitle

Please find below the amended Supporting Documentation. Changes from the original submission are highlighted in bold.
...
\begin{itemize}
  ...
  \item {\bf Walls:} The walls will be lined internally with studwork which will be in-filled with 75\mm\ EPS insulation.
...
\begin{itemize}
  \item {\bf Electrical:} No electrical sockets are planned for the porch. A single internal electrical internal light will be installed in the ceiling, and downward-directed external lights will be installed externally. All electrical light fittings will be installed or approved by a qualified electrician.
...
\begin{itemize}
  ...
  \item {\bf Roof:} {\bf A warm flat roof will be supported by 47\mm\ $\times$ 120\mm\ C24 joists, separated by a single set of noggins -- one between each pair of joists -- placed at the mid-point (i.e., roughly 1.1\,m from each wall). The three joists closest to the masonry parallel wall between the study and kitchen will be strapped to said wall by a 1.2\m\ galvanised steel strap}. One end of the joists will rest on the inner leaf of the extended wall between the extension and the garage, to which every other joist will be tied. The other end of the joists will be supported by joist hangers attached to a 47\mm\ $\times$ 120\mm\ C24 ledger running the entire length of the extension. The ledger will be bolted to the existing structure using M12 bolts resin-fixed to the existing structure at max. 400\mm\ horizontal spacings. The existing uninsulated garage roof will be extended forwards to meet the new front of the garage. {\bf The extension to the garage roof will be supported by 47\mm\ $\times$ 145\mm\ C24 joists. One end of the joists will rest on the outer leaf of the extended wall between the extension and the garage, to which every other joist will be tied.} The other end of the joists will be rest on the single leaf garage wall, to which every other joist will be tied.

\end{itemize}

\subsubsection{Heat and Sound Insulation}
\begin{itemize}
  \item {\bf Floor:} A 120\mm\ layer of EPS\cite{efins} insulation will insulate the concrete floor from the ground. The overall U-value of the floor is 0.15\uunit .
  \item {\bf Walls:} {\bf The 150\mm\ front-facing wall cavity will be partially filled with a 100\mm\ layer of Cavity Board Insulation.}\cite{ew1ins} The overall U-value of the front-facing wall is 0.17\uunit . The 85\mm\ cavity in the wall separating the extension from the garage will be fully-filled with mineral wool.\cite{ew2ins} A wider cavity cannot be created as the wall is extending an existing wall forward. The overall U-value of the extension/garage wall is 0.33\uunit. The single leaf garage wall will not be insulated.
...
\begin{itemize}
  ...
  \item {\bf Floor:} {\bf A suspended floor will be installed. The floor will be supported by 47\mm\ $\times$ 120\mm\ C24 joists -- separated by noggins every max. 1800\,mm -- which will rest on 85\mm\ high sleeper walls capped with a DPC and a timber wall plate. The sleeper wall will sit on the existing 100\,mm-thick concrete garage floor. Air bricks (with accompanying DPC trays) will be installed in the rear wall and side wall, and gaps in the sleeper walls will ensure good ventilation within the floor cavity. The joists will support 18\,mm plywood. Hence, the floor of the utility room will be approximately 293\,mm (sleeper walls $+$ joists $+$ ply) above the garage floor level. A single step will be built to aid access to the garage from the utility room.}
...
\begin{itemize}
  ...
  \item {\bf Walls:} {\bf The 150\mm\ rear-facing wall cavity will be partially filled with a 100\mm\ layer of Cavity Board Insulation.\cite{uw1ins} The overall U-value of the rear-facing wall is 0.17\uunit . The 125\mm\ cavity on the side wall will be partially-filled with 100\mm\ or Kingspan K112 framing boards or similar.\cite{uw2ins}. The overall U-value of the side wall is 0.34\uunit ; the U-value calculation assumed that the internal timber frame accounts for 15 per cent of the wall area.} The stud wall between the rear room and the garage will be fully-filled with 125\mm\ Kingspan K106\cite{uw3ins} insulation and lined on the rear room side with 40\mm\ insulated plasterboard.\cite{uw4ins} The total U-value for the rear room/garage wall is 0.17\uunit , again assuming the timber frame accounts for 15\% of the wall area.
...
\bibitem{selfclose}\href{https://www.screwfix.com/p/smith-locke-concealed-door-closer-radius-polished-chrome-95-144-5mm/1647g#product_additional_details_container}{Smith \& Locke Concealed Door Closer}
...
\bibitem{efins} \href{https://www.kingspan.com/gb/en/products/insulation-boards/floor-insulation-boards/thermafloor-tf70/}{Kingspan 120mm Thermafloor TF70. Thermal conductivity: 0.019 W/mK}

\bibitem{ew1ins} \href{https://www.kingspan.com/gb/en/products/insulation-boards/wall-insulation-boards/kooltherm-k108-cavity-board/} {Kingspan 100mm Kingspan Kooltherm K108 Partial Fill Cavity Wall Insulation. Thermal conductivity: 0.019 W/mK}
...
\bibitem{uw2ins} \href{https://www.kingspan.com/gb/en/products/insulation-boards/wall-insulation-boards/kooltherm-k112-framing-board/} {Kingspan Kooltherm K112 Framing Board Insulation. Thermal conductivity: 0.019 W/mK.}

\bibitem{smokestrips} \href{https://www.screwfix.com/p/firestop-intumescent-fire-smoke-seals-white-15mm-x-4mm-x-1050mm-5-pack/21295?kpid=21295&cm_mmc=Google-_-Datafeed-_-Security%20and%20Ironmongery?kpid=KINASEKPID&cm_mmc=Google-_-TOKEN1-_-TOKEN2&gclid=Cj0KCQjwgNanBhDUARIsAAeIcAskrccqxj_FkeALz2RQKp8NMojYi5_P2D-Trl_zrPR3DIf2FlZRFqoaAtSrEALw_wcB&gclsrc=aw.ds}{Firestop Intumescent Fire \& Smoke Seals White}

\bibitem{uw3ins} \href{https://www.kingspan.com/gb/en/products/insulation-boards/wall-insulation-boards/kooltherm-k106-cavity-board/}{Kingspan Kooltherm K106 Cavity Board}

\bibitem{uw4ins} \href{https://www.travisperkins.co.uk/thermal-insulated-plasterboard/celotex-pir-thermal-laminated-insulation-board-2400mm-x-1200mm-x-40mm-52-5mm-overall/p/778057} {Celotex PIR Thermal Laminated Insulation Board. Thermal conductivity: 0.022 W/mk.}

\bibitem{macerator}\href{https://www.screwfix.com/p/saniflo-sanitop-up-macerator-400w-220-240v/7924v}{Saniflo Sanitop Up Macerator 400W 220/240V}
